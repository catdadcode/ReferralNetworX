...
public partial class ArticleChecklist : System.Web.UI.Page
{
    ...
    protected void lbtnIUnderstand_Click(object sender, EventArgs e)
    {
        Response.Cookies["ReadArticleGuidelines"].Value = "true";
        Response.Cookies["ReadArticleGuidelines"].Expires = DateTime.Now.AddYears(1);
        Response.Redirect("ManageArticles.aspx", true);
    }
}
