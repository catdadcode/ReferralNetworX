...
public partial class Subscribe : System.Web.UI.Page
{
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        ...
        string sEmail = Request.QueryString["e"];
        ...
        if (sType == "newsletter")
        {
            dl.UnsubscribeNonMemberNewsletter(sEmail);
            mm.Subject = "Someone unsubscribed from the non-member newsletter.";
            mm.Body = sEmail + " unsubscribed from the non-member newsletter.";
        }
        else if (sType == "dailymotivator")
        {
            dl.UnsubscribeNonMemberDailyMotivator(sEmail);
            mm.Subject = "Non-member unsubscribed from the Daily Motivator.";
            mm.Body = sEmail + " unsubscribed from the Daily Motivator.";
        }

        SmtpMail.Send(mm);

        Session["resultColor"] = "#009900";
        Session["resultTitle"] = "Unsubscribe Successful";
        Session["resultMessage"] = "Sorry to see you go.";
    ...
    {
        Session["resultColor"] = "#009900";
        Session["resultTitle"] = "Unsubscribe Canceled";
        Session["resultMessage"] = "You canceled your unsubscribe request.";
        Session["resultReturnURL"] = "Default.aspx";
        Response.Redirect("Result.aspx", true);
    }
    ...
    {
        DataLayer dl = new DataLayer();
        dl.AddNonMember(tbxEmail.Text, tbxName.Text, cbxDailyMotivator.Checked, cbxNewsletter.Checked);
        Session["resultColor"] = "#009900";
        Session["resultTitle"] = "Subscribed";
        Session["resultMessage"] = "Thanks for subscribing!";
        Session["resultReturnURL"] = "Default.aspx";
        Response.Redirect("Result.aspx", true);
    }
}
