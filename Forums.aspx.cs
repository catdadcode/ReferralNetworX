...
public partial class Forums : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    Session["resultReturnURL"] = "Forums.aspx";
        //    Response.Redirect("Result.aspx", true);
        //}

        DataLayer dl = new DataLayer();
        DataTable dtForumBoards = dl.GetForumBoards();

        foreach (DataRow dr in dtForumBoards.Rows)
        {
            int iTopicCount = dl.GetTopicCountBy_BoardID(Convert.ToInt32(dr.ItemArray[0]));
            divBoards.Controls.Add(new LiteralControl("<div class=\"contenttitle\" style=\"text-align:left;\"><a class=\"titlelink\" href=\"Topics.aspx?board=" + dr.ItemArray[0].ToString() + "\">" + dr.ItemArray[1].ToString() + "</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;" + iTopicCount.ToString() + " topics</div><div class=\"contentpanel\">" + dr.ItemArray[2].ToString() + "</div>"));
        }
