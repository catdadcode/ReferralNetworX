...
public partial class EditAboutUs : System.Web.UI.Page
{
    ...
    {
        DataLayer dl = new DataLayer();
        dl.UpdateAboutUsContent(rteBody.Value);
        Session["resultColor"] = "#009900";
        Session["resultTitle"] = "About Us Updated";
        Session["resultMessage"] = "About Us Content Updated Successfully";
        Session["resultReturnURL"] = "AboutUs.aspx";
        Response.Redirect("Result.aspx");
    }
}
